    ...
    <section className="w-full">
      ...
      {!isUser && (
        <div className="flex gap-6 w-full">
          ...
          <aside className="w-80 flex-shrink-0 space-y-4">
            ...
            <div className="bg-gradient-to-br from-[#FFFFFF] to-[#BDBDBD]/10 rounded-xl 
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-[#757575] font-medium">Pedidos filtrados:</span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-[#757575] font-medium">Página actual:</span>
              ...
              <div className="mt-4 pt-4 border-t border-[#BDBDBD]/30">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-[#757575]">Actualizado en tiempo real</span>
                </div>
              </div>
            </div>
          </aside>
      ...
      {noOrders && isUser && (
        <div className="flex flex-col items-center justify-center py-16 animate-fade-in">
          <div className="bg-gradient-to-br from-[#BDBDBD]/10 to-transparent rounded-2xl 
                        border-2 border-[#BDBDBD]/30 p-8 text-center max-w-md">
            <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-[#BDBDBD]/20 to-[#757575]/20 
