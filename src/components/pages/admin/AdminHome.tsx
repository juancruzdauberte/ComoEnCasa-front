...
export const AdminHome = () => {
  ...
  return (
    <section className="mt-8 md:mt-20 bg-gradient-to-br from-[#FFFFFF] via-[#BDBDBD]/10 to-[#FFFFFF]">
      <section className="container mx-auto px-3 md:px-6 -mt-8 md:-mt-20 pb-6 md:pb-12">
        <div
          className="bg-[#FFFFFF] rounded-3xl shadow-2xl p-4 md:p-8 border-2 border-[#BDBDBD]/20 backdrop-blur-xl transform transition-all duration-500 hover:shadow-[#424242]/20 animate-scale-in"
